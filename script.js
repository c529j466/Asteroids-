...
const roidNum = 30; //starting number of asteroids
...
function newAsteroid(x, y) {
    var roid = {
        x: x,
        y: y,
        xv: Math.random() * roidSpeed / FPS * (Math.random() < 0.5 ? 1 : -1),
        yv: Math.random() * roidSpeed / FPS * (Math.random() < 0.5 ? 1 : -1),
        r: roidSize / 2,
